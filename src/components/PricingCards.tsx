    ...
    <div>
      <div className="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2">
        {tiers.map((tier) => (
          <div
            key={tier.id}
            className="flex flex-col justify-between rounded-3xl bg-white shadow-xl p-8 ring-1 ring-gray-900/10 sm:p-10"
          >
            <div>
              <h3
              ...
              <p className="mt-6 text-start text-base leading-7 text-gray-600">
                {tier.description}
              </p>
              ...
              >
                {tier.features.map((feature) => (
                  <li key={feature} className="flex gap-x-3">
                    <CheckIcon
                      className="h-6 w-5 flex-non text-indigo-600"
                      aria-hidden="true"
                    />
                    {feature}
                  </li>
